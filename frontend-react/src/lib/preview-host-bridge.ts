 ...
 * Top-level runs (local `npm run dev`, deployed sites) noop.
 */
...
export {
  isAllowedEmbedderOrigin,
  isSandboxPreviewGuestHost,
  resolveParentEmbedderOrigin,
} from "./preview-embedder-origin";

export const PREVIEW_BRIDGE_CHANNEL = "pdfin-preview-bridge" as const;
 ...
 * Noops when not embedded under an allowed parent.
 */
