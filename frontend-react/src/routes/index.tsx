...
function Home() {
  ...
  return (
    <div className="pb-8">
      ...
      <section className="mx-auto mt-14 max-w-6xl" aria-labelledby="tools-heading">
        <div className="flex flex-col gap-4 border-b border-border pb-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex gap-1 overflow-x-auto pb-1" role="tablist" aria-label="Kategori alat">
      ...
      <section className="mx-auto mt-16 grid max-w-6xl gap-4 border-t border-border pt-8 sm:grid-cols-3">
...
function ToolCard({ tool }: { tool: ToolDef }) {
  ...
  return (
    <Link
      ...
      className="group flex min-h-40 flex-col rounded-xl border border-border bg-surface p-5 transition-[border-color,box-shadow,transform] duration-150 hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-[var(--shadow-card-hover)]"
    >
